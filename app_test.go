...
func TestEmbeddedWebShell(t *testing.T) {
	...
	tests := []struct {
		...
		{path: "/", contentTypePrefixes: []string{"text/html"}, contains: []string{`<meta name="viewport"`, `href="./vendor/katex/katex.min.css?v=0.18.4"`, `href="./app.css?v=9"`, `href="./chroma.css?v=2"`, `src="./vendor/katex/katex.min.js?v=0.18.4"`, `src="./vendor/mermaid.min.js?v=11.17.2"`, `src="./app.js?v=10"`, `id="settings-popup"`, `id="demo-link"`, `id="document-path"`, `id="update-notice"`}},
