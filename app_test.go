...
func TestEmbeddedWebShell(t *testing.T) {
	...
	tests := []struct {
		...
		{path: "/", contentTypePrefixes: []string{"text/html"}, contains: []string{`<meta name="viewport"`, `href="./vendor/katex/katex.min.css?v=0.18.4"`, `href="./vendor/fonts/fonts.css?v=1"`, `href="./app.css?v=29"`, `href="./chroma.css?v=2"`, `src="./vendor/katex/katex.min.js?v=0.18.4"`, `src="./vendor/mermaid.min.js?v=11.17.2"`, `src="./app.js?v=29"`, `data-focus-key="reader"`, `id="settings-popup"`, `id="design"`, `id="appearance"`, `id="outline-rail"`, `id="demo-link"`, `id="document-path"`, `id="review-button"`, `id="review-panel"`, `id="review-comments"`, `id="comment-composer"`, `id="shortcut-button"`, `id="shortcut-dialog"`, `id="review-live-status"`, `id="update-notice"`}},
