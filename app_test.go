...
func TestEmbeddedWebShell(t *testing.T) {
	...
	tests := []struct {
		...
		{path: "/", contentTypePrefixes: []string{"text/html"}, contains: []string{`<meta name="viewport"`, `href="./vendor/katex/katex.min.css?v=0.18.4"`, `href="./vendor/fonts/fonts.css?v=`, `href="./app.css?v=`, `href="./chroma.css?v=`, `src="./vendor/katex/katex.min.js?v=0.18.4"`, `src="./vendor/mermaid.min.js?v=11.17.2"`, `src="./text-selection.js?v=`, `src="./app.js?v=`, `data-focus-key="reader"`, `id="settings-popup"`, `id="design"`, `id="appearance"`, `id="outline-rail"`, `id="demo-link"`, `id="document-path"`, `id="review-button"`, `id="review-panel"`, `id="review-comments"`, `id="comment-composer"`, `id="selection-comment-action"`, `id="shortcut-button"`, `id="shortcut-dialog"`, `id="review-live-status"`, `id="update-notice"`}},
		{path: "/app.css", contentTypePrefixes: []string{"text/css"}, contains: []string{":root", `data-design="ink"`, `data-design="signal"`, `data-design="column"`, ".outline-rail", ".review-panel", ".shortcut-dialog", ".md-block-review-controls", ".md-block-review-controls.has-composer", ".md-block.is-keyboard-active", "@keyframes content-updated"}},
		...
		{path: "/text-selection.js", contentTypePrefixes: []string{"text/javascript", "application/javascript"}, contains: []string{`"use strict"`, "buildIndex", "captureSelection"}},
